...
public class SearchByGroups extends Base {
	...
	@Test
	public void SearchingAGroup() throws InterruptedException, MalformedURLException
	{
		...
		//Click on Groups:
		driver.findElementByXPath("//*[contains(@content-desc,'Groups')]").click();
		...
		action.sendKeys(SearchBar,"Group 1").perform();
		
		//Click on Run:
		driver.findElementsByXPath("//android.widget.Button").get(3).click();
		
		//Click on Group 1 Albums:
		WebElement Group1 = driver.findElementByXPath("//android.view.View[@content-desc='Group 12']");
		t.tap(tapOptions().withElement(element(Group1))).perform();
